...
// vue-script:E:\william project\_myproject\mini-vite\example\App.vue?type=script
var App_default = defineComponent({
  setup() {
    const msg = "my mini-vite";
    const num = ref(1);
    const add2 = () => {
      num.value++;
    };
...
// vue-template:E:\william project\_myproject\mini-vite\example\App.vue?type=template
var _hoisted_1 = { style: { "font-size": "64px" } };
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("div", _hoisted_1, toDisplayString(_ctx.msg), 1),
    createBaseVNode("button", {
      onClick: _cache[0] || (_cache[0] = (...args) => _ctx.add && _ctx.add(...args))
    }, toDisplayString(_ctx.num), 1)
  ]);
}
